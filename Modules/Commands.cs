...
namespace TutorialBot.Modules
{
    public class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        // Image arrays for interactive commands
...
!გააგდე";
            ...
            await ReplyAsync($"**ხელმისაწვდომი ქომანდები:**\n{commandsList}");
        }
        ...
        public async Task KissUser(SocketUser user = null)
        {
            ...
            var builder = new EmbedBuilder()
                ...
                .WithDescription($"შენ აკოცე {user.Mention}'ს! 😘")
        ...
        // ================= MODERATION =================
        [Command("ბანი")]
        [Alias("ბანი დაადე")] // Allows the command to work even with spaces
        ...
        public async Task BanMember(IGuildUser user = null, [Remainder] string reason = null)
        {
            ...
            reason = reason ?? "არ არის მითითებული";
